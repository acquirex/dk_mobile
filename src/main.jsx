...
function App() {
  ...
  if (page === 'bathroom') return <div className="routed-dual-preview"><BathroomPage onBack={() => setPage('home')} onOpenHandles={() => setPage('shower-handles')} onQuote={()=>setPage('quote')}/><AndroidPreview/></div>;
  if (page === 'shower-handles') return <div className="routed-dual-preview"><ShowerHandlesPage onBack={() => setPage('bathroom')} onHome={() => setPage('home')} onOpenKnobs={() => setPage('shower-knobs')} onQuote={()=>setPage('quote')}/><AndroidPreview/></div>;
  if (page === 'shower-knobs') return <div className="routed-dual-preview"><ShowerKnobsPage onBack={() => setPage('shower-handles')} onHome={() => setPage('home')} onQuote={()=>setPage('quote')} onOpenProduct={product=>{setActiveProduct(product);setPage('product')}}/><AndroidPreview/></div>;
  if (page === 'product') return <div className="routed-dual-preview"><ProductDetailPage product={activeProduct} onBack={()=>setPage('shower-knobs')} onHome={()=>setPage('home')} onQuote={()=>setPage('quote')}/><AndroidPreview/></div>;
  if (page === 'quote') return <div className="routed-dual-preview"><RequestQuotePage onBack={()=>setPage('home')} onHome={()=>setPage('home')}/><AndroidPreview/></div>;
